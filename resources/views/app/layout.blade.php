...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('front/assets/css/app.css') }}?v=20">
...
<script src="{{ asset('assets/js/push/push-client.js') }}?v=6" defer data-push-config='@json(app(\App\Services\Push\PushManager::class)->clientConfig(auth()->user()))'></script>
