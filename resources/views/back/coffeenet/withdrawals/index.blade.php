...
@section('breadcrumb', 'پنل کافی‌نت ← برداشت‌ها')
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
    ...
    <div class="card ui-lift p-6 animate-fade-up space-y-4 h-fit overflow-hidden relative">
        ...
        <form id="withdraw-form" class="space-y-4" novalidate>
            ...
            <button type="submit" id="w-submit" class="btn-primary btn-shine w-full !py-3">ثبت درخواست برداشت</button>
        </form>
...
<div id="page-data" hidden data-payload="{{ json_encode(['base' => '/coffeenet/' . $coffeenet->id . '/withdrawals']) }}"></div>

@endsection

@push('scripts')
<script src="{{ asset('back/assets/js/pages/coffeenet/withdrawals/index.js') }}"></script>
@endpush
