...
(function () {
    ...
    function syncOfflineDesc() {
        ...
        nsOfflineDesc.innerHTML = on
            ? 'کاربرِ بدونِ درخواستِ بیشتر از <b>' + sec.toLocaleString('fa-IR') + '</b> ثانیه «آفلاین» است و پوش سیستمی می‌گیرد — همین آستانه در جزئیات کاربران و داشبورد هم نمایش داده می‌شود. اگر لحظهٔ ارسال آنلاین بود و بعد برنامه‌اش را بست، پوش تا ~۱ دقیقه بعد (چک دوره‌ای هر ۱۰ ثانیه) خودکار می‌رود.'
