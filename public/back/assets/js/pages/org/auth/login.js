/**
 * کافی‌نت آنلاین — اسکریپت صفحه «back/assets/js/pages/org/auth/login.js»
...
(function () {
    ...
    document.getElementById('login-form').addEventListener('submit', async (e) => {
        ...
        try {
            const res = await App.ajax('/organization/login', {
                method: 'POST',
                body: { email, password },
            });
            ...
            if (res.ok) {
                ...
                setTimeout(() => { window.location = data.redirect || '/organization'; }, 600);
