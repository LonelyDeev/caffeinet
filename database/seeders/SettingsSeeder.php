...
class SettingsSeeder extends Seeder
{
    public function run(): void
    {
        $rows = [
            ...
            ['group' => 'notifications', 'key' => 'notification.push.offline_enabled', 'value' => '1', 'cast' => 'boolean', 'label' => 'آستانهٔ آفلاین فعال باشد؟ (خاموش = حالت کوتاه ۹۰ ثانیه)'],
            ['group' => 'notifications', 'key' => 'notification.push.offline_seconds', 'value' => '180', 'cast' => 'integer', 'label' => 'پس از چند ثانیه بی‌فعالیتی، کاربر «آفلاین» فرض شود (حداقل ۹۰)'],
